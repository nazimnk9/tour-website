                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        ...
                        <div className="w-full lg:w-1/2 ">
                            <h4 className="text-orange-500 uppercase tracking-widest text-sm font-semibold mb-4">
                            ...
                            <p className="text-dark/70 text-[15px] leading-relaxed mb-3">
                            ...
                            <p className="text-dark/70 text-[15px] leading-relaxed mb-10">
                            ...
                            <div className="flex flex-wrap gap-6 items-center">
                                {/* <button className="bg-[#86bc24] hover:bg-[#75a61f] text-white px-8 py-4 rounded-xl font-semibold flex items-center gap-2 transition-all transform hover:scale-105 shadow-lg">
                                    <Mail size={18} />
                                    Let&apos;s talk now
                                </button> */}
                ...
                <section className="relative min-h-screen w-full overflow-hidden">
                  ...
                  <div className="relative z-10 flex min-h-screen items-center">
                    <div className="mx-auto w-full max-w-7xl px-4 py-16 text-center text-white sm:px-6 lg:px-8">
                      <span className="mb-3 block text-xs font-semibold uppercase tracking-[0.2em] text-orange-500 sm:text-sm">
                        Great Experience
                      </span>

                      <h2 className="mb-10 text-3xl font-semibold leading-tight sm:text-4xl md:mb-14 md:text-5xl">
                        Why choose us
                      </h2>
