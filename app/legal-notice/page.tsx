    ...
    return (
        <div className="min-h-screen bg-white font-sans text-[#051036]">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <h1 className="text-2xl font-semibold leading-tight mb-8">Legal Notice</h1>

                <div className="prose prose-slate max-w-none space-y-6 text-gray-600 leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-semibold text-[#051036] mb-4">1. Identification</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-[#051036] mb-4">2. Intellectual Property</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-[#051036] mb-4">3. Limitation of Liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-[#051036] mb-4">4. Governing Law</h2>
                        <p>
