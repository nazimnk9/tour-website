    ...
    return (
        <div className="min-h-screen bg-white font-sans text-[#051036]">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-8">Privacy Policy</h1>

                <div className="prose prose-slate max-w-none space-y-6 text-gray-600 leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-bold text-[#051036] mb-4">1. Information We Collect</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-[#051036] mb-4">2. How We Use Your Information</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-[#051036] mb-4">3. Data Sharing and Disclosure</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-[#051036] mb-4">4. Your Rights</h2>
                        <p>
